exec {
	main {
		...
		mov r4, number // Compiles to: mov r0, #address_of_number_immed
		...
		add r0, number[r1], x[r2] // Adds addresses of vars. Compiles to: mov r1, number; mov r2, x; add r0, r1, r2
		add r0, number[r1], x[r2] // Adds addresses of vars. Tries to compile to: mov r1, number; add r0, r1, #address_of_x_immed. Fails when cannot generate
